...
export default function HomeNewsletter() {
  return (
    <section
      ...
      className="mx-auto w-full max-w-5xl px-6 pb-20 text-center md:px-0"
    >
      <div className="space-y-6 rounded-3xl border border-[#3e3ce7]/20 bg-white shadow-xl shadow-[rgba(12,20,18,0.35)]">
        <div className="border-b border-[#3e3ce7]/15 px-8 py-8 sm:px-12">
          <h2
            id="newsletter-signup"
            className="text-2xl font-bold tracking-tight text-[#0C1412] sm:text-3xl"
          >
            Join the EBikeReviewLab Insider Brief
          </h2>
          <p className="mt-4 text-base leading-relaxed text-[#0C1412]/75">
        ...
        <div className="space-y-6 px-6 pb-10 sm:px-12">
          ...
          >
            ...
            <input
              ...
              className="flex-1 rounded-full border border-[#3e3ce7]/30 bg-white px-5 py-3 text-sm text-[#0C1412] shadow-sm shadow-[rgba(12,20,18,0.35)] placeholder:text-[#0C1412]/40 focus:border-[#3e3ce7] focus:outline-none focus:ring-2 focus:ring-[#3e3ce7]/30"
            />
            <button
              type="submit"
