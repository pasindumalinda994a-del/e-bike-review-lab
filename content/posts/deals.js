 ...
 * Deal Articles
 *
 * Lightweight deal roundups with intro, deal cards (H2 + pros/cons), and internal links.
...
export const dealArticles = [
  {
    ...
    deals: [
      ...
      },
      {
        ...
        badge: "Save $300",
        description:
          "$300 off the Discover 2 brings it to $1,699. This is Velotric's comfort commuter line, and the Discover series is probably their most popular category. If you want something you can ride every day without overthinking it, the Discover 2 is a solid middle-ground option. It's not as budget-focused as the Fold 1 deal above, but a meaningful discount on a bike a lot of people would actually want.",
        ...
        limitedStock: false,
        pros: [
          "Discover series is Velotric's bread and butter, with a proven design and a lot of real-world riders behind it",
        ...
        cons: [
          "No accessories included at this price point, unlike a few other deals in this sale that come with add-ons",
      ...
      },
      {
        ...
        cons: [
          "The MTC vs non-MTC pricing adds a layer of complexity, so confirm which version you're looking at before checkout",
      ...
      },
      {
        ...
        cons: [
          "$200 off a $2,000 bike is on the smaller side. Ten percent isn't the most dramatic sale in this lineup",
      ...
      },
      {
        ...
        limitedStock: false,
        pros: [
          "Discover 3 is the current top commuter in Velotric's lineup, with 80-mile range, 750W motor, and 28 mph top speed",
          "Phone mount is a practical add-on that most riders end up buying anyway",
        ],
        cons: [
          "No actual price cut. $1,999 is still full retail, and the savings are accessory value only",
    ...
    internalLinks: [
      ...
      },
      {
        ...
        description:
          "Updated weekly with the e-bike deals actually worth your time",
      },
      {
