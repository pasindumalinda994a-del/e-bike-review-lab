...
const chathamRevPlus2Article = {
  ...
  category: "Retrospec Electric Bikes",
  contentType: "brand",

  // ============================================
  // 2. SEO & METADATA -- THE 3 KINGS
  // ============================================
  title: "Retrospec Chatham Rev+ 2 Review 2026: Best Electric Beach Cruiser?",
  seoTitle: "Chatham Rev+ 2 Review 2026: Best Beach Cruiser E-Bike?", // KING 2 — 57 chars
  h1: "Retrospec Chatham Rev+ 2 Step-Through Review: Tested on Real Rides", // KING 3
  metaDescription:
  ...
  articleHeroImage:
    "/images/brand/retrospec/Chatham Rev+ 2 Beach Cruiser Electric Bike - Step Through.webp",
  heroImageAlt:
    "Retrospec Chatham Rev+ 2 Step-Through electric beach cruiser bike in Matcha green on a beachfront boardwalk",
  ...
  quickSummary: {
    ...
    ratingMatrix: {
      ...
      metrics: [
        ...
        { category: "Display/Controls", rating: 8.5 },
  ...
  keySpecifications: {
    ...
    motorBattery: [
      { label: "Motor", value: "500W 48V Geared Rear Hub (Ananda)" },
      { label: "Battery", value: "48V / 500Wh, LG 21700 Li-ion cells" },
      { label: "Claimed range", value: "Up to 75 miles" },
      { label: "Charge time", value: "Approximately 5-6 hours (empty to full)" },
      { label: "UL Certification", value: "UL2849 & UL2271 Certified" },
    ],
    performance: [
      { label: "Top assisted speed", value: "20 mph (Class 2)" },
      { label: "Throttle", value: "Left thumb throttle" },
      { label: "Assist modes", value: "PAS levels 1-4, plus throttle and walk mode" },
      { label: "Sensor type", value: "Cadence sensor" },
    ],
    frameBuild: [
      { label: "Frame style", value: '16" Step-Through, Alloy' },
      { label: "Rider height range", value: '5\'2" to 6\'1"' },
      { label: "Standover height", value: '24"' },
    ...
    components: [
      {
        label: "Brakes",
        value: "Tektro Mechanical Disc, 180mm rotors, semi-metallic pads",
      },
      { label: "Drivetrain", value: "Shimano Tourney 7-speed, 14-34T freewheel" },
      { label: "Tires", value: '26" x 3.0" with puncture protection' },
      { label: "Display", value: "Full color center-mounted TFT (Ananda)" },
      { label: "Saddle", value: "Selle Royal Gel" },
      { label: "Headlight", value: "Integrated 80 Lux, 12V" },
      { label: "Taillight", value: "Fender-mounted with brake light function" },
    ],
  },
  ...
  designAndBuildQuality: {
    ...
    image: {
      ...
      alt: "Close-up of the Retrospec Chatham Rev+ 2 step-through alloy frame showing integrated battery and clean cable routing",
      description:
  ...
  motorPerformanceAndPower: {
    ...
    image: {
      ...
      alt: "Retrospec Chatham Rev+ 2 rear hub motor and 26x3.0 puncture-protected tire detail",
      description:
  ...
  batteryAndRangeTest: {
    ...
    image: {
      ...
      alt: "Retrospec Chatham Rev+ 2 integrated 48V 500Wh LG battery in the downtube frame",
      description:
  ...
  rideQualityAndComfort: {
    ...
    image: {
      image: "/images/brand/retrospec/Chatham Rev+ 2 Beach Cruiser Electric Bike - Step Through Comfort.webp",
      alt: "Woman riding Retrospec Chatham Rev+ 2 step-through electric beach cruiser on a sunny coastal boardwalk",
      description:
  ...
  componentsAndFeatures: {
    ...
    image: {
      ...
      alt: "Tektro mechanical disc brake with 180mm rotor on the Retrospec Chatham Rev+ 2 electric beach cruiser",
      description:
  ...
  displayAppUserExperience: {
    ...
    image: {
      image: "/images/brand/retrospec/Chatham Rev+ 2 Beach Cruiser Electric Bike - Step Through Screen.webp",
      alt: "Ananda full color TFT display and handlebar controls on the Retrospec Chatham Rev+ 2 electric cruiser bike",
      description:
  ...
  alternativesToConsider: {
    ...
    comparisons: [
      {
        modelComparison: "Retrospec Chatham Rev+ 2 vs Electra Townie Go! 7D",
        optionA: {
        ...
        optionB: {
          label: "Choose Electra Townie Go! 7D if...",
          points: [
      ...
      {
        modelComparison: "Retrospec Chatham Rev+ 2 vs Rad Power Bikes RadCity 5 Plus",
        optionA: {
          label: "Choose Chatham Rev+ 2 if...",
          points: [
  ...
  faq: [
    ...
    {
      question: "What is the top speed of the Chatham Rev+ 2?",
      answer:
    ...
    {
      question: "How does the Chatham Rev+ 2 compare to the Electra Townie Go! 7D?",
      answer:
    ...
    {
      question: "What is the weight limit on the Chatham Rev+ 2?",
      answer:
    ...
    {
      question: "Does the Chatham Rev+ 2 have an app or Bluetooth connectivity?",
      answer:
