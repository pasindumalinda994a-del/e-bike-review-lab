...
const FERLA_PLACEHOLDER = "/default-og.png";
...
const ferlaRoyceIIArticle = {
  ...
  // 3. IMAGES
  // ============================================
  heroImage: FERLA_PLACEHOLDER,
  cardImage: FERLA_PLACEHOLDER,
  articleHeroImage: FERLA_PLACEHOLDER,
  heroImageAlt:
  ...
  prosCons: {
    ...
    whatWeLike: [
      ...
      "Three-wheel trike platform stands on its own and doesn't require balancing — first-time cargo bike owners can get comfortable quickly",
  ...
  rideQualityAndComfort: {
    ...
    paragraphs: [
      ...
      "After 60-90 minute rides, the upright riding position holds up well. Saddle quality is decent without being exceptional — a longer-term owner might swap it out. No notable wrist or back fatigue at a comfortable pace, which is what you want from something designed for daily family use rather than sport riding.",
    ],
    image: {
      image: FERLA_PLACEHOLDER,
