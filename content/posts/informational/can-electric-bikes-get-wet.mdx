...
<ArticleImage
  src="/images/info/can-electric-bikes-get-wet%201.webp"
  alt="Electric bike ridden through light rain on a wet city street"
  caption="A normal wet commute is usually fine — most e-bikes are built for rain, not submersion."
/>
...
<ArticleImage
  src="/images/info/can-electric-bikes-get-wet%202.webp"
  alt="E-bike charging port and battery connector dried before plugging in"
  caption="Let the charging port and battery connector dry fully before you plug in — that's where the real risk sits."
/>
