...
<ArticleImage
  src="/images/info/can-electric-bikes-climb-steep-hills%201.webp"
  alt="Electric bike climbing a steep grade with pedal assist"
  caption="Most e-bikes can handle real hills — how comfortably depends on torque, gearing, and motor type."
/>
...
<ArticleImage
  src="/images/info/can-electric-bikes-climb-steep-hills%202.webp"
  alt="Mid-drive versus hub motor e-bike climbing a steep hill"
  caption="Mid-drives use the bike's gears for climbing leverage; hub motors push a more constant power that works harder on steep grades."
/>
...
Want to understand the mechanics behind all of this in more detail? Check out our guide on [how electric bikes work](/guides/how-electric-bike-works). And if you're still narrowing down which model fits your commute, our [complete electric bike buying guide](/guides/what-electric-bike-should-i-buy) breaks down what to look for beyond just the hill-climbing specs. For [high-torque models from our reviews](/electric-bikes/best-electric-bikes), see the main roundup, or compare [best electric mountain bikes for trails](/electric-mountain-bikes/best-electric-mountain-bikes) if hills are the whole point.
