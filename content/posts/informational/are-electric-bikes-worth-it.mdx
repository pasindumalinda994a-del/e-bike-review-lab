...
<ArticleImage
  src="/images/info/are-electric-bikes-worth-it-1.png"
  alt="Rider on a step-through electric bike suited for seniors and riders with mobility limitations"
  caption="Step-through frames and pedal assist keep riding accessible when hills or joint pain would otherwise end the trip early."
/>
...
<ArticleImage
  src="/images/info/are-electric-bikes-worth-it-2.png"
  alt="Two riders on electric bikes enjoying a recreational ride together"
  caption="E-bikes make longer rides and mixed-ability group outings more accessible — a common reason recreational riders stick with them."
/>
...
Ready to see which models we ranked highest? Check [our tested best electric bikes roundup](/electric-bikes/best-electric-bikes). For the cost/ROI math against driving, see [is it worth getting an electric bike](/electric-bikes/is-it-worth-getting-electric-bike).
