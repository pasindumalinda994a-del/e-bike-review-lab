...
const products = [
  ...
  },
  {
    ...
    // 3. IMAGES
    // ============================================
    heroImage: "/images/electric-cargo-bikes/riese-muller-carrie.webp",
    cardImage: "/images/electric-cargo-bikes/riese-muller-carrie.webp",
    articleHeroImage: "/images/electric-cargo-bikes/riese-muller-carrie.webp",
    ...
    imagePrimary: {
      ...
      image: "/images/electric-cargo-bikes/riese-muller-carrie-flex-box.webp",
    ...
    imageSecondary: {
      ...
      image: "/images/electric-cargo-bikes/riese-muller-carrie-compact.webp",
      ...
      groups: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Child cover ($187) provides weather protection but prevents the Flex Box from fully closing—you'll need to plan around this limitation",
  ...
  },
  {
    ...
    // 3. IMAGES
    // ============================================
    heroImage: "/images/electric-cargo-bikes/tern-quick-haul-long-d9.webp",
    cardImage: "/images/electric-cargo-bikes/tern-quick-haul-long-d9.webp",
    articleHeroImage: "/images/electric-cargo-bikes/tern-quick-haul-long-d9.webp",
    ...
    imagePrimary: {
      ...
      image: "/images/electric-cargo-bikes/tern-quick-haul-long-d9-vertical.webp",
    ...
    imageSecondary: {
      ...
      image: "/images/electric-cargo-bikes/tern-quick-haul-long-d9-kickstand.webp",
      ...
      groups: [
        ...
        },
        {
          ...
          bullets: [
            ...
            "Charging takes 4.5 hours from empty using the included 4A charger. Battery locks with same key as frame lock—one less thing to remember",
        ...
        },
        {
          ...
          bullets: [
            "Rear rack rated to 198 lb and compatible with two Clubhouse+ seats or one adult passenger. I tested with two kids (ages 5 and 7) using aftermarket seats—plenty of room and heel clearance while pedaling",
        ...
        },
        {
          ...
          bullets: [
            "20\" wheels lower the center of gravity dramatically compared to 26\" cargo bikes. Loaded handling felt stable and predictable—no scary rear-end sway even on quick turns",
    ...
    prosCons: {
      heading: "Pros & Cons",
      pros: [
        "Rides like a regular bike when unloaded—no dead steering or awkward handling that plagues most cargo bikes",
        ...
        "DIN 79010 safety certification means frame is tested to handle advertised 419 lb load—not just marketing claims",
      ...
      cons: [
        ...
        "Accessory installation isn't intuitive—adding Stow Decks and seats took 65 minutes total following instructions; faster systems exist",
  ...
  },
  {
    ...
    // 3. IMAGES
    // ============================================
    heroImage: "/images/electric-cargo-bikes/riese-muller-packster-70.webp",
    cardImage: "/images/electric-cargo-bikes/riese-muller-packster-70.webp",
    articleHeroImage: "/images/electric-cargo-bikes/riese-muller-packster-70.webp",
    ...
    imagePrimary: {
      ...
      image: "/images/electric-cargo-bikes/riese-muller-packster-70-box.webp",
    ...
    imageSecondary: {
      ...
      description: "The cable steering initially felt strange coming from traditional bikes, but after two days it clicked. The tight turning radius—seriously, you can U-turn in a narrow bike lane—makes urban navigation a breeze. In tight parking garages and crowded bike paths, this system proved its worth repeatedly. There's minimal maintenance compared to traditional linkage systems, and the precision remained consistent even after 300+ miles.",
      image: "/images/electric-cargo-bikes/riese-muller-packster-70-steering.webp",
    ...
    features: {
      ...
      groups: [
        ...
        },
        {
          title: "Safety & Visibility Features",
          bullets: [
            "Supernova M99 headlight with 1,250 lumens is overkill in the best way—illuminated bike paths like daylight. Integrated brake light and daytime running lights keep you visible 24/7",
    ...
    prosCons: {
      ...
      cons: [
        ...
        "Purion display is basic and hard to read in direct sunlight—battery indicator jumps in 20% increments instead of precise percentage, which is frustrating on longer rides",
  ...
  },
  {
    ...
    // 3. IMAGES
    // ============================================
    heroImage: "/images/electric-cargo-bikes/riese-muller-multitinker2.webp",
    cardImage: "/images/electric-cargo-bikes/riese-muller-multitinker2.webp",
    articleHeroImage: "/images/electric-cargo-bikes/riese-muller-multitinker2.webp",
    ...
    imagePrimary: {
      ...
      image: "/images/electric-cargo-bikes/riese-muller-multitinker2-rear-rack.webp",
    ...
    imageSecondary: {
      ...
      image: "/images/electric-cargo-bikes/riese-muller-multitinker2-bosch-system.webp",
    ...
    features: {
      ...
      groups: [
        ...
        },
        {
          title: "Adjustability & Fit",
          bullets: [
            "Tool-free adjustable stem moves handlebar position up/down and forward/back with quick-release levers—makes sharing between riders of different heights genuinely practical",
            ...
            "Low step-over height (about 18 inches) makes mounting/dismounting easy even with cargo loaded—big advantage over traditional diamond-frame designs",
        ...
        },
        {
          ...
          bullets: [
            "Enviolo CVT hub (Vario model) allows gear changes while stopped—absolute lifesaver at stoplights on hills with heavy loads, though slightly less efficient than derailleur systems",
  ...
  },
  {
    ...
    // 3. IMAGES
    // ============================================
    heroImage: "/images/electric-cargo-bikes/cube-cargo-hybrid.webp",
    cardImage: "/images/electric-cargo-bikes/cube-cargo-hybrid.webp",
    articleHeroImage: "/images/electric-cargo-bikes/cube-cargo-hybrid.webp",
    ...
    imagePrimary: {
      ...
      image: "/images/electric-cargo-bikes/cube-cargo-hybrid-box.webp",
    ...
    imageSecondary: {
      ...
      image: "/images/electric-cargo-bikes/cube-cargo-hybrid-motor.webp",
      ...
      groups: [
        {
          ...
          bullets: [
            ...
            "Motor cuts power smoothly when you stop pedaling or hit 15.5mph (25km/h) EU limit—no jerky transitions"
          ]
        },
        {
          ...
          bullets: [
            ...
            "Multiple drain holes in the bottom make cleaning easy after rainy rides or spilled drinks—learned this quickly with kids",
        ...
        },
        {
          ...
          bullets: [
            "SR Suntour Mobie34 cargo-specific fork with 80mm travel smooths out potholes and speed bumps—noticeable improvement for front box passengers",
            ...
            "Upright riding position is genuinely comfortable for extended rides—no back strain after 45-minute trips"
          ]
        },
        {
          title: "Braking & Safety Features",
          bullets: [
            ...
            "Brakes performed consistently in wet conditions during testing—never felt sketchy stopping with kids aboard",
    ...
    prosCons: {
      heading: "Pros & Cons",
      pros: [
        "Bosch Cargo Line motor delivers smooth, powerful assist even on steep hills with 60kg loads—never felt strained during testing",
        "200L cargo box is wider than some competitors, giving two kids comfortable side-by-side seating without feeling cramped",
        "One-Size-Fits-All design actually works—both 5'4\" and 5'10\" riders comfortable with quick adjustments between users",
        "Aluminum alloy frame resists rust and weighs less than steel competitors while maintaining cargo bike durability",
        "800Wh battery provides 35-40 miles real-world range with mixed loads and terrain—enough for week of school runs per charge",
      ...
      cons: [
        "100-pound weight makes the bike genuinely difficult to maneuver when not riding—lifting up curbs or stairs is a two-person job",
        "Different sized tires (20\" front, 27.5\" rear) means keeping two types of spares and can't rotate tires between wheels",
        "29.5-inch width won't fit through some narrow bike gates and requires dedicated storage space—doesn't work in apartment hallways",
        "Enviolo CVT version struggles on sustained climbs over 10% grade with heavy loads—Shimano Deore option better for hilly areas",
        ...
        "Essential accessories sold separately—seats with harnesses (£150), rain cover (£100), rear rack all cost extra on top of base price"
      ]
    },
